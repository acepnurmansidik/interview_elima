...
Route::get('/', function () {
  ...
  $filter = "WHERE YEAR (data_absen.tgl_kerja) = 2024";
...
order by 
  data_absen.tgl_kerja ASC;
    ...
    return view('welcome', ["dataEmps" => $data_kehadiran, "header" =>count($data_kehadiran) == 0 ? []: $data_kehadiran[0]['absensi_kehadiran']]);
});
...
order by 
  data_absen.tgl_kerja ASC;
    ...
    return view('welcome', ["dataEmps" => $data_kehadiran, "header" =>count($data_kehadiran) == 0 ? []: $data_kehadiran[count($data_kehadiran)-1]['absensi_kehadiran']]);
});
